...
<div class="dropdown">
  <button class="dropdown-btn" style="outline:none; color:var(--info-color); border-color:var(--info-color);">Abstract</button>
  <div class="dropdown-content" style="display:none; font-size: 0.75rem;">
